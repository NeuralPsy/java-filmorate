...
CREATE TABLE IF NOT EXISTS LIKED_FILMS (
        ...
        USER_ID BIGINT,
        LAST_UPDATE DATE,
        CONSTRAINT LIKED_FILMS_FK FOREIGN KEY (FILM_ID) REFERENCES FILMS(ID) ON DELETE CASCADE,
        CONSTRAINT LIKED_FILMS_FK_1 FOREIGN KEY (USER_ID) REFERENCES USERS(ID) ON DELETE CASCADE
);
