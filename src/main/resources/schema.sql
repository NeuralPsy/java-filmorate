...
CREATE TABLE IF NOT EXISTS FILMS (
      ...
      CONSTRAINT MPA_ID_FK FOREIGN KEY (MPA_RATING) REFERENCES MPA(ID) On Update Cascade
);
...
CREATE TABLE IF NOT EXISTS LIKED_FILMS (
        ...
        LAST_UPDATE DATE,
        CONSTRAINT LIKED_FILMS_FK FOREIGN KEY (FILM_ID) REFERENCES FILMS(ID) On Update Cascade,
        CONSTRAINT LIKED_FILMS_FK_1 FOREIGN KEY (USER_ID) REFERENCES USERS(ID) On Update Cascade
);
...
CREATE TABLE IF NOT EXISTS FILM_GENRE (
       ...
       GENRE_ID SMALLINT REFERENCES GENRE(GENRE_ID) On Update Cascade,
       LAST_UPDATE DATE
);
